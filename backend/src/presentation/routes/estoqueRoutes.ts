...
/**
 * @route   GET /api/estoque/produtos
 * @desc    Lista produtos com informações completas de estoque e lotes
 * @access  Private (Vendedor+)
 * @query   page, limit, search, categoria, status, laboratorio, orderBy, incluirLotes
 */
router.get(
  '/produtos',
  requireEstoquePermission('visualizacao'),
  estoqueController.listarProdutosEstoque.bind(estoqueController)
);
