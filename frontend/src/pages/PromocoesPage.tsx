...
export default function PromocoesPage() {
  ...
  return (
    <Layout>
      <div className="p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Promoções</h1>
          <p className="text-gray-600">Gerencie as promoções da farmácia</p>
        </div>
        ...
        {pagination.totalPages > 1 && (
          <div className="mt-6 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => loadPromocoes(currentPage - 1)}
