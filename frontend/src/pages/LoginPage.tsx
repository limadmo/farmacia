      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-6">
          <div className="text-center text-sm text-gray-600">
            Sistema para controle de farmácia
          </div>
          <div className="mt-4 border-t pt-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs text-gray-600">
              ...
              <div className="text-center">
                <div className="font-medium text-gray-800">Gerente</div>
                <div>gerente / gerente123</div>
              </div>
              <div className="text-center">
                <div className="font-medium text-gray-800">Farmacêutico</div>
                <div>farmaceutico / farmaceutico123</div>
              </div>
              <div className="text-center">
                <div className="font-medium text-gray-800">Vendedor</div>
                <div>vendedor / vendedor123</div>
              </div>
            </div>
          </div>
        </div>
